...
class OneMaxGA(GeneticAlgorithm):
    ...
    def calculate_cumulative_probabilities(self) -> List[float]:
        ...
        cumulative_probabilities = [self.evaluate_fitness(chromosome) / total_fitness for chromosome in self.population]
    ...
    def run(self, max_generations):
        for generation in range(max_generations):
            ...
            new_population = new_population[:self.population_size - self.elitism_num]
